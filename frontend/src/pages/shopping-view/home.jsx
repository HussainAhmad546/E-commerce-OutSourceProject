...
//   { id: "america-fc", label: "AMERICA FC", icon: ShirtIcon },
//   { id: "chivas-fc", label: "CHIVAS FC", icon: CloudLightning },
//   { id: "mexico-team", label: "MEXICO TEAM", icon: BabyIcon },
//   { id: "cruz-azul-fc", label: "CRUZ AZUL FC", icon: WatchIcon },
//   { id: "real-madrid", label: "REAL MADRID", icon: UmbrellaIcon },
//   { id: "castore-red-bull", label: "CASTORE RED BULL", icon: ShirtIcon },
//   { id: "nike-af1-white", label: "NIKE AF1 WHITE", icon: CloudLightning },
//   { id: "nike-af1-black", label: "NIKE AF1 BLACK", icon: BabyIcon },
// ];
