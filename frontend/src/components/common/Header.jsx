...
import { Sheet, SheetContent, SheetTrigger } from "../smallCommonComponents/SheetsVariants";
import { Button } from "../smallCommonComponents/ButtonVariants";
import { useDispatch, useSelector } from "react-redux";
import { shoppingViewHeaderMenuItems } from "@/constant";
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Avatar className="bg-black">
            <AvatarFallback className="bg-blue-500 text-white hover:bg-blue-700 font-extrabold cursor-pointer">
