...
const Footer = () => {
  ...
  return (
    <>
      <footer className="bg-gradient-to-r from-gray-300 via-[#62ace9] to-gray-300">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src={logo} className="mr-5 h-16" alt="logo" />
        <p className="max-w-xs mt-4 text-sm text-gray-700">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia ipsam ea aperiam, numquam assumenda dolorem, officiis fugit velit veniam, nemo eius minima odit totam facilis enim dolores placeat aut autem.
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-700">
            <Link className="hover:opacity-75" to="/shop/privacy-policy"> Privacy Policy </Link>
            <Link className="hover:opacity-75" to="/shop/terms-of-service"> Terms &amp; Conditions </Link>
